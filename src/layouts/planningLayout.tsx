...
const PlanningLayout: FC = () => {
    const location = useLocation();
    const currentPath = location.pathname;

    const links = [
        { id: 1, title: 'Budgeting', path: '/plannings', icon: <RiMoneyDollarCircleLine size={20} /> },
        { id: 2, title: 'Financial Goals', path: '/plannings/financial_goals', icon: <TbPigMoney size={20} /> },
    ];
    ...
    return (
        <div className="flex h-full">
            ...
            >
                <div className="px-3 pb-5 font-black">Planning</div>
